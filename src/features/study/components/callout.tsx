...
> = {
  tip: {
    ...
    text: "text-[#177544] dark:text-[#23a563]",
    dot: "bg-[#23a563]",
    label: "Dica",
  },
  caution: {
    ...
    text: "text-[#a15505] dark:text-[#d97706]",
    dot: "bg-[#d97706]",
    label: "Cuidado",
  },
  definition: {
    ...
    text: "text-[#0a7194] dark:text-[#149eca]",
    dot: "bg-[#149eca]",
    label: "Definição",
  },
  example: {
    ...
    text: "text-[#6b46c1] dark:text-[#7c57e1]",
    dot: "bg-[#7c57e1]",
    label: "Exemplo",
  },
  simulation: {
    ...
    text: "text-[#0e7490] dark:text-[#06b6d4]",
    dot: "bg-[#06b6d4]",
    label: "Simulação",
  },
  connection: {
